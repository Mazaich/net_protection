...
Мы видим, что Suricata успешно детектировала атаку Hydra! В логах fast.log есть множество событий, связанных с SSH сканированием и попытками подбора паролей.

Обнаруженные сигнатуры:
ET SCAN Potential SSH Scan (ID: 2001219) - детектирование потенциального SSH сканирования
ET SCAN Potential SSH Scan OUTBOUND (ID: 2003068) - исходящее SSH сканирование
SURICATA SSH invalid banner (ID: 2228000) - неверный баннер SSH
ET SCAN LibSSH Based Frequent SSH Connections Likely BruteForce Attack (ID: 2006546) - частые SSH подключения, вероятно атака brute force

Источник атаки: 192.168.100.20 (Kali Linux)
Цель: 192.168.100.10 (Ubuntu) порт 22
Время атаки: 12:42:51 03.11.2025
Тип атаки: SSH brute force (подбор паролей)
...
Скриншоты:
1. ![Скриншот](https://github.com/Mazaich/net_protection/blob/main/VirtualBoxVM_FdEjTV7I6k.png?raw=true)
